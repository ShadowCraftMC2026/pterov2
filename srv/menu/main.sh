...
echo
echo -e "${C3}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "                 ${BOLD}Own By - ShadowCraftMC${NC} ${C2}2026 ${C3}Update 4.0 Soon"
echo -e "${C1}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo
}
# ===================== PANEL MENU =====================
...
case $p in
 ...
 6) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/pterov2/refs/heads/main/srv/Uninstall/dash-v4.sh) ;;
 7) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/pterov2/refs/heads/main/srv/Uninstall/unPaymenter.sh) ;;
 8) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/-150/refs/heads/main/Uninstall/unCtrlPanel.sh) ;;
 9) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/pterov2/refs/heads/main/srv/Uninstall/unReviactyl.sh) ;;
...
case $t in
 ...
 2) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/vpsmaker/refs/heads/main/srv/tools/Tailscale.sh) ;;
 3) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/vpsmaker/refs/heads/main/srv/tools/cloudflare.sh) ;;
 4) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/vpsmaker/refs/heads/main/srv/tools/SYSTEM.sh) ;;
 5) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/-150/refs/heads/main/tools/vps.sh) ;;
 6) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/vpsmaker/refs/heads/main/srv/tools/terminal.sh) ;;
 7) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/vpsmaker/refs/heads/main/srv/tools/rdp.sh) ;;
 8) break;;
...
case $th in
 1) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/PteroShadowMC/refs/heads/main/cd/Blueprint2.sh) ;;
 2) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/PteroShadowMC/refs/heads/main/cd/chang.sh) ;;
...
case $c in
 1) bash <(curl -s https://raw.githubusercontent.com/ShadowCraftMC2026/vpsmaker/refs/heads/main/main-menu.sh) ;;
 2) panel_menu ;;
